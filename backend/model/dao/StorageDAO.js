...
function StorageDAO(file) {
    return __awaiter(this, void 0, void 0, function () {
        var app, folder, fileName, storage, refs, snapshot, link, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    app = (0, FirebaseAdapter_1.FirebaseAdapter)();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    folder = 'thumbnails/';
                    ...
                    refs = (0, storage_1.ref)(storage, folder + fileName);
                    return [4 /*yield*/, (0, storage_1.uploadBytesResumable)(refs, file.buffer, {
